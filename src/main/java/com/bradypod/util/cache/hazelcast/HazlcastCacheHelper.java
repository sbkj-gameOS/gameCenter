package com.bradypod.util.cache.hazelcast;

import com.bradypod.core.BMDataContext;
import com.bradypod.util.cache.CacheBean;
import com.bradypod.util.cache.CacheInstance;
import com.bradypod.util.cache.hazelcast.impl.ApiUserCache;
import com.bradypod.util.cache.hazelcast.impl.GameCache;
import com.bradypod.util.cache.hazelcast.impl.GameRoomCache;
import com.bradypod.util.cache.hazelcast.impl.MultiCache;
import com.bradypod.util.cache.hazelcast.impl.OnlineCache;
import com.bradypod.util.cache.hazelcast.impl.QueneCache;
import com.bradypod.util.cache.hazelcast.impl.SystemCache;
/**
 * Hazlcast缓存处理实例类
 * @author admin
 *
